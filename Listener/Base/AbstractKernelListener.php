...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from melody mixer app';
     *     $event->getRequest()->attributes->set('PaustianMelodyMixerModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('PaustianMelodyMixerModule_test');`
     *     now `$testMessage` should be: `'Hello from melody mixer app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf(
     *             'melody mixer App Error says: %s with code: %s',
