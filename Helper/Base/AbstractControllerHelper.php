...
abstract class AbstractControllerHelper
{
    ...
    /**
     * Returns an array of all allowed object types in PaustianMelodyMixerModule.
     *
    ...
    public function getObjectTypes(string $context = '', array $args = []): array
    {
        ...
        $allowedObjectTypes = [];
        $allowedObjectTypes[] = 'gameScore';
        $allowedObjectTypes[] = 'score';
        $allowedObjectTypes[] = 'level';
        $allowedObjectTypes[] = 'graphicsAndSound';
        $allowedObjectTypes[] = 'musicScore';
    
        return $allowedObjectTypes;
    }
    
    /**
     * Returns the default object type in PaustianMelodyMixerModule.
     */
    ...
    public function processViewActionParameters(
        ...
        $showOnlyOwnEntriesSetting = (bool)$request->query->getInt(
            'own',
            (int) $this->variableApi->get('PaustianMelodyMixerModule', 'showOnlyOwnEntries')
        );
        ...
        if (1 !== $templateParameters['all']) {
            ...
            if (in_array($resultsPerPage, [0, 10], true)) {
                $resultsPerPage = $this->variableApi->get('PaustianMelodyMixerModule', $objectType . 'EntriesPerPage', 10);
            }
        }
        ...
        $quickNavFormType = 'Paustian\MelodyMixerModule\Form\Type\QuickNavigation\\'
        ...
        if (1 === $templateParameters['all']) {
            ...
            $paginator->setRoute('paustianmelodymixermodule_' . strtolower($objectType) . '_' . $templateParameters['routeArea'] . 'view');
