...
/**
 * Level quick navigation form type base class.
 */
abstract class AbstractLevelQuickNavType extends AbstractType
{
    /**
     * @var RequestStack
     */
    ...
    public function addOutgoingRelationshipFields(FormBuilderInterface $builder, array $options = []): void
    {
        ...
        $builder->add('graphicsAndSound', ChoiceType::class, [
        ...
        $builder->add('musicScores', ChoiceType::class, [
            'choices' => /** @Ignore */$choices,
            'choice_label' => function ($entity) use ($entityDisplayHelper) {
                return $entityDisplayHelper->getFormattedTitle($entity);
            },
    ...
    {
        $listEntries = $this->listHelper->getEntries('level', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'paustianmelodymixermodule_levelquicknav';
    }
