...
/**
 * Score quick navigation form type base class.
 */
abstract class AbstractScoreQuickNavType extends AbstractType
{
    /**
    ...
    {
        $listEntries = $this->listHelper->getEntries('score', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
        ...
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'choices' => [
                    ...
                    'Score four' => 'scoreFour',
                    'Score five' => 'scoreFive',
                    'Score six' => 'scoreSix',
                    'Score seven' => 'scoreSeven',
                    'Score eight' => 'scoreEight',
                    'Score nine' => 'scoreNine',
                    'Score ten' => 'scoreTen',
    ...
    {
        return 'paustianmelodymixermodule_scorequicknav';
    }
