...
/**
 * Music score quick navigation form type base class.
 */
abstract class AbstractMusicScoreQuickNavType extends AbstractType
{
    /**
    ...
    {
        $listEntries = $this->listHelper->getEntries('musicScore', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'paustianmelodymixermodule_musicscorequicknav';
    }
