...
namespace Paustian\MelodyMixerModule\Entity\Repository\Base;
 ...
 *
 * This is the base repository class for level entities.
 */
abstract class AbstractLevelRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = LevelEntity::class;

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'levelName';
     ...
     *
     * @return array|LevelEntity Retrieved data array or levelEntity instance
     */
     ...
     *                       (optional) (default=false)
     *
     * @return array Retrieved LevelEntity instances
     */
    public function selectByIdList(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('level', $qb);
        }
    ...
    public function getListQueryBuilder(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('level', $qb);
        }
    ...
    public function selectSearch(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('level', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numLevels';
    ...
    public function selectCount(string $where = '', bool $useJoins = false, array $parameters = []): int
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('level', $qb, $parameters);
        }
    ...
    {
        $selection = ', tblGraphicsAndSound, tblMusicScores';
    ...
    {
        $qb->leftJoin('tbl.graphicsAndSound', 'tblGraphicsAndSound');
        $qb->leftJoin('tbl.musicScores', 'tblMusicScores');
