 ...
 *
 * This is the base repository class for graphics and sound entities.
 */
abstract class AbstractGraphicsAndSoundRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = GraphicsAndSoundEntity::class;

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'levelid';
     ...
     *
     * @return array|GraphicsAndSoundEntity Retrieved data array or graphicsAndSoundEntity instance
     */
     ...
     *                       (optional) (default=false)
     *
     * @return array Retrieved GraphicsAndSoundEntity instances
     */
    public function selectByIdList(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('graphicsAndSound', $qb);
        }
    ...
    public function getListQueryBuilder(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('graphicsAndSound', $qb);
        }
    ...
    public function selectSearch(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('graphicsAndSound', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numGraphicsAndSound';
    ...
    public function selectCount(string $where = '', bool $useJoins = false, array $parameters = []): int
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('graphicsAndSound', $qb, $parameters);
        }
