 ...
 *
 * This is the base repository class for game score entities.
 */
abstract class AbstractGameScoreRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = GameScoreEntity::class;
     ...
     *
     * @return array|GameScoreEntity Retrieved data array or gameScoreEntity instance
     */
     ...
     *                       (optional) (default=false)
     *
     * @return array Retrieved GameScoreEntity instances
     */
    public function selectByIdList(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('gameScore', $qb);
        }
    ...
    public function getListQueryBuilder(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('gameScore', $qb);
        }
    ...
    public function selectSearch(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('gameScore', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numGameScores';
    ...
    public function selectCount(string $where = '', bool $useJoins = false, array $parameters = []): int
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('gameScore', $qb, $parameters);
        }
