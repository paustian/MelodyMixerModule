 ...
 *
 * This is the base repository class for score entities.
 */
abstract class AbstractScoreRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = ScoreEntity::class;
     ...
     *
     * @return array|ScoreEntity Retrieved data array or scoreEntity instance
     */
     ...
     *                       (optional) (default=false)
     *
     * @return array Retrieved ScoreEntity instances
     */
    public function selectByIdList(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('score', $qb);
        }
    ...
    public function getListQueryBuilder(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('score', $qb);
        }
    ...
    public function selectSearch(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('score', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numScores';
    ...
    public function selectCount(string $where = '', bool $useJoins = false, array $parameters = []): int
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('score', $qb, $parameters);
        }
