 ...
 *
 * This is the base repository class for music score entities.
 */
abstract class AbstractMusicScoreRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = MusicScoreEntity::class;
     ...
     *
     * @return array|MusicScoreEntity Retrieved data array or musicScoreEntity instance
     */
     ...
     *                       (optional) (default=false)
     *
     * @return array Retrieved MusicScoreEntity instances
     */
    public function selectByIdList(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('musicScore', $qb);
        }
    ...
    public function getListQueryBuilder(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('musicScore', $qb);
        }
    ...
    public function selectSearch(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('musicScore', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numMusicScores';
    ...
    public function selectCount(string $where = '', bool $useJoins = false, array $parameters = []): int
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('musicScore', $qb, $parameters);
        }
