...
use Paustian\MelodyMixerModule\Controller\Base\AbstractGameScoreController;
...
/**
 * Game score controller class providing navigation and interaction functionality.
 */
class GameScoreController extends AbstractGameScoreController
{
    /**
     *
     * @Route("/admin/gameScores",
     *        methods = {"GET"}
     * )
     * @Theme("admin")
     */
    ...
    /**
     *
     * @Route("/admin/gameScores/view/{sort}/{sortdir}/{page}/{num}.{_format}",
    ...
    /**
     *
     * @Route("/gameScores/view/{sort}/{sortdir}/{page}/{num}.{_format}",
     *        requirements = {"sortdir" = "asc|desc|ASC|DESC", "page" = "\d+", "num" = "\d+", "_format" = "html|csv|rss|atom|xml|json"},
     *        defaults = {"sort" = "", "sortdir" = "asc", "page" = 1, "num" = 10, "_format" = "html"},
     *        methods = {"GET"}
     * )
    ...
    /**
     *
     * @Route("/admin/gameScore/edit/{id}.{_format}",
    ...
    /**
     *
     * @Route("/gameScore/edit/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
     *        defaults = {"id" = "0", "_format" = "html"},
     *        methods = {"GET", "POST"}
     * )
    ...
    /**
     * @Route("/admin/gameScores/setScores",
     *        methods = {"GET", "POST"}
     * )
     * @Theme("admin")
     */
    ...
    /**
     *
     * @Route("/admin/gameScore/delete/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
    ...
    /**
     *
     * @Route("/gameScore/delete/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
     *        defaults = {"_format" = "html"},
     *        methods = {"GET", "POST"}
     * )
     ...
     *
     * @Route("/admin/gameScores/handleSelectedEntries",
     *        methods = {"POST"}
     * )
     * @Theme("admin")
     */
     ...
     * Process status changes for multiple items.
     *
     * @Route("/gameScores/handleSelectedEntries",
     *        methods = {"POST"}
     * )
     */
