...
use Paustian\MelodyMixerModule\Controller\Base\AbstractGraphicsAndSoundController;
...
/**
 * Graphics and sound controller class providing navigation and interaction functionality.
 */
class GraphicsAndSoundController extends AbstractGraphicsAndSoundController
{
    /**
     *
     * @Route("/admin/graphicsAndSound/edit/{id}.{_format}",
    ...
    /**
     *
     * @Route("/graphicsAndSound/edit/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
     *        defaults = {"id" = "0", "_format" = "html"},
     *        methods = {"GET", "POST"}
     * )
    ...
    /**
     *
     * @Route("/admin/graphicsAndSound/view/{sort}/{sortdir}/{page}/{num}.{_format}",
    ...
    /**
     *
     * @Route("/graphicsAndSound/view/{sort}/{sortdir}/{page}/{num}.{_format}",
     *        requirements = {"sortdir" = "asc|desc|ASC|DESC", "page" = "\d+", "num" = "\d+", "_format" = "html|csv|rss|atom|xml|json"},
     *        defaults = {"sort" = "", "sortdir" = "asc", "page" = 1, "num" = 10, "_format" = "html"},
     *        methods = {"GET"}
     * )
    ...
    /**
     *
     * @Route("/admin/graphicsAndSound/delete/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
    ...
    /**
     *
     * @Route("/graphicsAndSound/delete/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
     *        defaults = {"_format" = "html"},
     *        methods = {"GET", "POST"}
     * )
     ...
     *
     * @Route("/admin/graphicsAndSound/handleSelectedEntries",
     *        methods = {"POST"}
     * )
     * @Theme("admin")
     */
     ...
     * Process status changes for multiple items.
     *
     * @Route("/graphicsAndSound/handleSelectedEntries",
     *        methods = {"POST"}
     * )
     */
