...
use Paustian\MelodyMixerModule\Form\Type\ConfigType;
...
abstract class AbstractConfigController extends AbstractController
{
    ...
    public function configAction(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('paustianmelodymixermodule_config_config');
        }
        ...
        return $this->render('@PaustianMelodyMixerModule/Config/config.html.twig', $templateParameters);
    }
}
